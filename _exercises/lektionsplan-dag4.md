# RACE 4 - Søgning, Modal & Deployment

## Formål

Formålet med dagens lektion er at færdiggøre jeres Movie App med søgefunktion, modal dialog og deploye den til internettet så I kan dele den med venner og familie!

**Mål:**

- Implementere søgefunktion med input event
- Kombinere `.filter()` og `.includes()` til text search
...
**9:30 - 10:30 | Søgefunktion Implementation (60 min)**
...
- Code-along step-by-step:
  ...
  - CSS: Styled search bar
  - JavaScript: Search logic med filter
...
- Close modal: X button, backdrop click, ESC key
...
- Tilføj ESC key til at lukke modal
...
- [Movie App - DAG 4 Simplified](https://github.com/cederdorff/js-movie-app/blob/simplified-version/_exercises/movie-app-4-simplified.md)
...
- GitHub Pages (simplified version): https://cederdorff.com/js-movie-app/
