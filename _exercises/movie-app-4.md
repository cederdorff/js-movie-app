...
### Trin 1: Tilføj sortering på rating

**Problem:** Din sort dropdown mangler måske "Rating" option!

**1a. Opdater HTML sort dropdown**

Åbn din `index.html` og sørg for at din sort dropdown har alle options:
...
**1b. Verificer rating sortering virker**

Din `filterMovies()` funktion skulle allerede understøtte rating sortering. Test det:

1. **GEM og refresh** browseren
2. **Vælg "Rating" i sort dropdown**
3. **Se at film med højeste rating kommer først**
...
## Del 5: Modal Tilgængelighed og UX 🚀
